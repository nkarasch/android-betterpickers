...
public class YearPickerView extends ListView implements OnItemClickListener, OnDateChangedListener {
    ...
    public YearPickerView(Context context, CalendarDatePickerController controller) {
        ...
        setDividerHeight(0);
        onDateChanged();
        mThemeDark = false;//TODO put default style reference here
    }
    ...
    private class YearAdapter extends ArrayAdapter<String> {
        ...
        public View getView(int position, View convertView, ViewGroup parent) {
            ...
            if (res!= null) {
                v.setBackgroundColor(res.getColor(mThemeDark ?  R.color.bpLight_gray : R.color.bpWhite));
                v.setCircleColor(res.getColor(mThemeDark ? R.color.bpRed : R.color.bpBlue));
